...
<head>
    ...
    <meta charset="utf-8">
    <title>Total Theses Number Chart as Supervisor</title>
    <link rel="stylesheet" href="welcome_nosingin.css">
    <script src="teacher_statistics_number_supervisor_script.js"></script>
</head>
<body>
    <nav>
    ...
    <div class="seethroughbox">
        <h2 class="form-title">Total Theses Number Chart as Supervisor</h2>
