...
$committee_query = "SELECT c.co_id, c.co_prof_1_grade, c.co_prof_2_grade, c.co_supervising_prof_grade, c.co_prof_1_id, c.co_prof_2_id, t.the_title  
                    FROM committee c 
...
if ($stmt = $con->prepare($committee_query)) {
    $stmt->bind_param('iii', $the_co_id, $professor_id, $professor_id);
    $stmt->execute();
    $stmt->bind_result($co_id, $co_prof_1_grade, $co_prof_2_grade, $co_supervising_prof_grade, $co_prof_1_id, $co_prof_2_id, $the_title);
    ...
    while ($stmt->fetch()) {
        $grades[] = [
            ...
            'the_title' => $the_title,
            'is_co_prof_1' => ($professor_id == $co_prof_1_id),
            'is_co_prof_2' => ($professor_id == $co_prof_2_id)
        ];
    }
