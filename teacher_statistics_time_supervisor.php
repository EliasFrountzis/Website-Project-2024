...
<head>
    ...
    <meta charset="utf-8">
    <title>Average Finished Thesis Chart</title>
    <link rel="stylesheet" href="welcome_nosingin.css">
    <script src="teacher_statistics_time_supervisor_script.js"></script>
</head>
<body>
    <nav>
    ...
    <div class="seethroughbox">
        <h2 class="form-title">Average Finished Thesis Chart</h2>
