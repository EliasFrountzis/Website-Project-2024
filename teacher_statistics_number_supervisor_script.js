...
$(document).ready(function() {
    ...
    function loadChartData() {
        $.ajax({
            url: 'super_thesis_number_data.php', // This is the PHP file that fetches the data
            method: 'GET',
            dataType: 'json',
                        ...
                        options: {
                            scales: {
                                ...
                                x: {
                                    ...
                                    ticks: {
                                        color: 'rgba(255, 255, 255, 1)', // Brighter color for X-axis ticks
                                        grid: {
