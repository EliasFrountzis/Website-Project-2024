...
<head>
    ...
    <script>
        $(document).ready(function() {
            // αυτόματα φορτώνονται τα δεδομένα όταν φορτωθεί η σελίδα
            $.ajax({
                url: 'studentthesisshow.php',
                type: 'GET',
...
<body>
    ...
    <div>
        <div class="seethroughbox2">
            ...
            <div id="dataContainer"> <!-- τα δεδομένα θα φαίνονται εδώ --> </div>
        </div>
    </div>
</body>
</html>
