...
<head>
    ...
    <meta name="viewport" content="width=device-width,initial-scale=1.0"/>
    <script src="thesis_search2.js"></script> 
</head>
<body>
    <nav>
    ...
    <div class="seethroughbox">
        <form id="thesisSearchForm">
            <input type="text" id="searchthesis" name="searchthesis" placeholder="Search Thesis">
            <button type="submit">Search</button>
        </form>
        <div id="thesisResults"></div>
    </div>
</body>
</html>
